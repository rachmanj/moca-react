...
export default function CreateReceipt({ migiDetails }: CreateReceiptProps) {
    ...
    const { data, setData, post, processing, errors, reset } = useForm({
        ...
        item_code: '',
        desc: '',
        qty: '1', // Changed to string to avoid NaN issues
        weight_total: '0', // Changed to string to avoid NaN issues
        project: '',
        remarks: '',
        given_by: '',
        received_by: '',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(route('oldcores.receipts.store'), {
            onSuccess: () => {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create Oldcore Receipt" />
            ...
            <div className="px-4 sm:px-6 lg:px-8">
                <div className="sm:flex sm:items-center">
                    <div className="sm:flex-auto">
                        ...
                        <h1 className="text-xl font-semibold text-gray-900 dark:text-white">Create Oldcore Receipt</h1>
                        <p className="mt-2 text-sm text-gray-700 dark:text-gray-300">Create a new receipt for oldcore items.</p>
                    </div>
                </div>
